...
def get_transp(student_id):
    ...
    if not t:
        return jsonify({"student_id": student_id, "utiliza_van": None, "endereco_rota": None, "observacoes": None})
    return jsonify({"student_id": student_id, "utiliza_van": t.utiliza_van, "endereco_rota": t.endereco_rota, "observacoes": t.observacoes})
